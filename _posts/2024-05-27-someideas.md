...
**计算认知神经科学**的重点一定是**认知**而不是在其他两个上，只做计算完全可以去转行做 LLM+ Agent 去投 ACL 故事会；只做神经为什么不跟生物人一起搞全神经元记录，发不了 cell 堆了这么高维的数据也能去忽悠物理批数学人发个 Phys Rev X/Letters。
